...
const LOCALES = {
    zh: {
        ...
        statusHint:   '💡 每行一条五元组图灵机指令 | 用other表示其他的纸带记号 | 按F5执行程序',
        noErrors:     '无错误',
        errorCount:   n => `错误: ${n}`,
    ...
    en: {
        ...
        statusHint:   '💡 Each line is a quintuple Turing machine instruction | Use "other" for other tape symbols | Press F5 to run the program',
        noErrors:     'No errors',
